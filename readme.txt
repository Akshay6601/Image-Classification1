...
Step 3: Change the path of the dataset by just simply copy-pasting the path from your system's file explorer. This is a necessay step. The code will not work if the path to the daaset is incorrect.
